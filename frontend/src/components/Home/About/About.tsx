...
const AboutSection = () => {
  ...
  const cards = [
    {
      title: "For Teachers",
      content: "Our AI-driven insights help you monitor student progress, track performance, and make data-backed decisions to ensure the best results for your students.",
      icon: (
    ...
    {
      title: "For Students",
      content: "Get customised learning roadmaps based on your strengths, weaknesses, and learning patterns, helping you optimise your study time and reach your academic goals.",
      icon: (
    ...
    {
      title: "For Parents",
      content: "We provide parents with real-time progress updates and detailed reports, giving them peace of mind about their child's academic journey.",
      icon: (
    ...
    >
      ...
      <div className='relative w-[90%] md:w-[80%] mx-auto h-full flex items-center'>
        <div className='grid grid-cols-1 xl:grid-cols-2 gap-15 w-full items-center'>
                ...
                <AnimatePresence>
                  {isInView && (
                    <>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          <div className="text-3xl font-bold text-blue-600 
                            bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-blue-400">98%</div>
                          <div className="text-sm text-gray-700">Student<br />Satisfaction</div>
                        </div>
                      </motion.div>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          <div className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-purple-400">5x</div>
                          <div className="text-sm text-gray-700">Performance<br />Improvement</div>
                        </div>
                      </motion.div>
                    </>
                  )}
          ...
          <motion.div style={{ y: textParallax }} className="order-1 xl:order-1">
            <motion.span
              initial="hidden"
            ...
            >
              We help you to take your Coaching Class to the Next Level by Empowering Students, Enhancing
              Coaching with the use of AI.
            </motion.p>
