      ...
      <div className="relative w-[90%] md:w-[80%] mx-auto h-full flex items-center">
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-10 w-full items-center">
          ...
          >
            ...
            >
              Revolutionising JEE Preparation with AI-Driven Personalised
              Roadmaps to Maximize Your Academic Potential
            </motion.p>
            ...
            >
              ...
              <Link href="/demo" passHref>
                <button
                  className="px-8 py-3 bg-transparent border-2 border-blue-600 text-blue-600 
